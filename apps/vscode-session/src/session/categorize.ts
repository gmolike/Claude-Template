...
const RULES: { category: SkillCategory; keywords: string[] }[] = [
  {
    category: 'Review',
    keywords: ['review', 'refactor', 'code-review', 'security-review', 'receiving-code'],
  },
  ...
  { category: 'Testing', keywords: ['test', 'tdd', 'debug', 'systematic-debug', 'verification'] },
  {
    ...
    keywords: ['seo', 'geo', 'content', 'schema', 'llms', 'citability', 'brand-mention', 'e-e-a-t'],
  },
  {
    category: 'Automation',
    keywords: [
  ...
  },
  {
    ...
    keywords: ['api', 'mcp', 'stripe', 'webhook', 'claude-api', 'notion', 'slack', 'twilio'],
  },
  {
    category: 'Dev Tools',
    keywords: [
